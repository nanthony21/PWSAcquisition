...
public abstract class SaverThread extends Thread implements ImageSaver {
   ...
   public abstract void setMetadata(
         MetadataBase md); //We allow the metadata that needs to be saved to be passed after the thread has started. This is how the metadata is set.

   @Override
   public void addImage(
         Image img) { //A queue is used to pass images from the acquisition thread to the saving thread. This method allows us to access the thread.
      q_.add(img);
   }
