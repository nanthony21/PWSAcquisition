...
public class DisabledPanel extends JPanel {
    ...
    * DisabledPanel. When a DisabledPanel is disabled it is registered with the DisabledEventQueue.
   ...
   static class DisabledEventQueue extends EventQueue
      ...
      /**
       * Check if any component on the DisabledPanel is using Key Bindings. If so, then track the
       * bindings and use a custom EventQueue to intercept the KeyStroke before it is passed to the
       * component.
       */
