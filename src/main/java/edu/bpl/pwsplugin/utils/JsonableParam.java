...
public class JsonableParam {   
    ...
    static {
        GsonUtils.builder().registerTypeAdapterFactory(adapter); //Register the runtime type adapter with Gson.
    }

    public static synchronized final void registerClass(Class<? extends JsonableParam> c) { //Each subclass of JsonableParam must be registered with this method or loading from JSON will not work.
    ...
    public void toJsonFile(String path) throws IOException { //Save the object directly to a text file.
    ...
    public static JsonableParam fromJsonFile(String path, Class clazz) throws FileNotFoundException { //Load a new instance of this class from a JSON file.
        Gson gson = GsonUtils.getGson();
        FileReader reader;
    ...
    public static  JsonableParam fromJson(String jsonStr, Class clazz) { //Load a new instance of this class from a JSON string.
        Gson gson = GsonUtils.getGson();
        return (JsonableParam) gson.fromJson(jsonStr, clazz);
    }
    
    public static JsonableParam fromJson(JsonObject obj, Class clazz) { //Load a new instance of this class from a GSON "JsonObject"
        Gson gson = GsonUtils.getGson();
