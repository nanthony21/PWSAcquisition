...
public class CopyMoveTransferHandler extends TransferHandler {
   ...
   public boolean canImport(TransferHandler.TransferSupport support) {
      ...
      try {
         nodes = (List<CopyableMutableTreeNode>) support.getTransferable()
      ...
      try {
         ...
         dropNode = (DefaultMutableTreeNode) tree.getModel()
               .getRoot();// In some cases the path can be null. Treat this as though dropping to the root.
      }
   ...
   public boolean importData(TransferHandler.TransferSupport support) {
      ...
      if (dest
            == null) { //In cases where there is only the root node this can happen. Just treat it like the destination is the root
